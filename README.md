[Web page](http://rontieu.com/UserSearch/) that displays a list of users with a search bar created using [Create React App](https://github.com/facebook/create-react-app). 
